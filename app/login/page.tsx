...
<form onSubmit={handleSubmit} className="space-y-4 mb-6">
  <div>
    <input
      ...
      required
      className="w-full h-12 px-4 border-2 border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:border-purple-500 transition-colors"
    />
  </div>
  ...
  <div className="relative">
    <input
      ...
      required
      className="w-full h-12 px-4 pr-12 border-2 border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:border-purple-500 transition-colors"
    />
    <button
      type="button"
