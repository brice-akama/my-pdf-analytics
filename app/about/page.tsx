      ...
      <div className="border-b border-slate-100">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 pt-16 pb-12">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-slate-900 leading-tight mb-5">
            We built DocMetrics because documents should not be invisible after you send them.
          </h1>
          <p className="text-base sm:text-lg text-slate-500 leading-relaxed max-w-2xl">
            ...
            teams, founders, recruiters, and professionals real-time visibility
            into how their documents are read, shared, and acted upon.
          </p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="space-y-12">
          ...
          <div>
            ...
            <p className="text-base text-slate-600 leading-relaxed">
              We envision a future where every shared document is a measurable
              channel for learning, conversion, and continuous improvement —
              not an email attachment that disappears into silence.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-4">
              The problem DocMetrics solves is simple but expensive. Every day,
              professionals send documents that represent real business
          ...
          <div>
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-4">
              All documents uploaded to DocMetrics are encrypted in transit and
              at rest. Access controls are enforced at every layer — from
              individual link settings to folder-level permissions inside data
              rooms. Every action taken inside a Space is recorded in a
              tamper-evident audit log.
            </p>
            <p className="text-base text-slate-600 leading-relaxed">
              We do not sell your data or your documents to third parties. We
              use your data only to provide and improve the Service. You retain
              full ownership of everything you upload and can export or delete
          ...
          <div className="rounded-2xl bg-sky-600 px-8 py-12 text-center">
            ...
            <p className="text-base text-white/80 max-w-xl mx-auto mb-8">
              Upload your first document and see real engagement data in under
      ...
      <div className="border-t border-slate-100">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-6">
          <p className="text-sm text-slate-400">
            © {new Date().getFullYear()} DocMetrics — Document intelligence for modern teams.
          </p>
        </div>
      </div>
