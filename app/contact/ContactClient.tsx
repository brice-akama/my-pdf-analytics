...
// ── CLIENT COMPONENT (form + accordion state) ─────────────────
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="border border-slate-200 rounded-2xl p-6">
              ...
              <div className="space-y-4">
                {[
                  { label: "General Support",    time: "Within 1 business day", dot: "bg-green-400" },
                  { label: "Technical Issues",   time: "Within 1 business day", dot: "bg-green-400" },
                  { label: "Billing Questions",  time: "Within a few hours",    dot: "bg-sky-400"   },
                  { label: "Security Reports",   time: "Within 48 hours",       dot: "bg-amber-400" },
                ].map((item) => (
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.department}>
                    <p className="text-xs font-semibold text-slate-500 mb-0.5">{item.department}</p>
                    <a href={`mailto:${item.email}`} className="text-sm font-medium text-sky-600 hover:underline">
                      {item.email}
                    </a>
        ...
        <div className="mt-20">
          <div className="mb-8">
            ...
            <p className="text-base text-slate-500 leading-relaxed">
              Check if your question is already answered here before sending a message.
            </p>
          </div>
