...
import { Check, FileText, Users, Lock, BarChart3, Video, Download, Shield, Eye, Folder, Droplet, AlertCircle, Mail, Gauge, Cloud, Zap } from "lucide-react"
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 pt-16 pb-12 text-center">
        ...
        <p className="text-base sm:text-lg text-slate-500 leading-relaxed max-w-2xl mx-auto mb-10">
          Start free and scale as you grow. Every plan includes the core features you need to track, share, and close deals faster.
        </p>
        ...
        <div className="mt-16">
          <div className="rounded-2xl bg-indigo-600 px-8 py-14 sm:px-14 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <Link href="/contact" className="inline-flex items-center gap-2 border border-white/40 text-white font-medium px-8 py-3 rounded-xl hover:bg-white/10 transition-colors text-sm">
                Contact us
              </Link>
            </div>
